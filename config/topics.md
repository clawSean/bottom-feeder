...
- Secrets management for small teams (Infisical, Vault, Doppler) ← next run priority
- Supply chain attack protections for npm/package ecosystems ← next run priority
